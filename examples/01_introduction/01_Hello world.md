...
3. `println` and `print` writes a line to the standard output with cursor in new line and in same line respectively. It is imported implicitly. Also note that semicolons are optional.
